pub const WORD_LIST: &[&str] = &[
    ...
    "basis", "beach", "beard", "begin", "being", "below", "bench", "berry", "birth", "black",
    "blade", "blame", "blank", "blast", "bleed", "blend", "bless", "blind", "block", "blood",
    "board", "boost", "booth", "bound", "brain", "brand", "brave", "bread", "break", "breed",
    "brief", "bring", "broad", "brown", "brush", "build", "built", "buyer", "cable", "carry",
    "catch", "cause", "chain", "chair", "chart", "chase", "cheap", "check", "chest", "chief",
    "child", "china", "chose", "civil", "claim", "class", "clean", "clear", "click", "clock",
    "close", "cloud", "coast", "color", "comes", "comic", "count", "court", "cover", "crack",
    ...
    "grown", "guard", "guess", "guest", "guide", "happy", "harry", "heart", "heavy", "hello",
    ...
    "woman", "women", "world", "worse", "worst", "worth", "would", "wound", "write", "wrong",
